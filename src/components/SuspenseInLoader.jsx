...
import { createQueryOptionsForSuspenseInLoader } from '../utils/helperFunction'

const SuspenseInLoader = () => {
    const {data} = useSuspenseQuery(createQueryOptionsForSuspenseInLoader())
    // console.log(data)
  return (
...
export default SuspenseInLoader