...
import { createQueryOptionsForSuspense } from "../utils/helperFunction";

const UseSuspense = () => {
  const { data } = useSuspenseQuery(createQueryOptionsForSuspense());
  // console.log(error); no lodaing and error state is it handle by suspense and error boundary
